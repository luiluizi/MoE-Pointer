...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm", type=str, default='mapt', choices=["mapt", "prob_heuristic", "cpsat", "nearest", "ga", "sa", "mapdp"])
    ...
    # parser.add_argument("--n_rollout_threads", type=int, default=256, help="Number of parallel envs for training rollouts")
    # parser.add_argument("--num_episodes", type=int, default=1<<14, help='Number of environment steps to train (default: 10e6)')
    parser.add_argument("--n_rollout_threads", type=int, default=4, help="Number of parallel envs for training rollouts")
    parser.add_argument("--num_episodes", type=int, default=1<<5, help='Number of environment steps to train (default: 10e6)')
    ...
    parser.add_argument("--aux_loss_coef", type=float, default=0.1, help='entropy term coefficient (default: 0.01)')
    ...
    # parser.add_argument("--n_enc_block", type=int, default=10)
    # parser.add_argument("--n_dec_block", type=int, default=6)
    ...
    # dataset
    parser.add_argument("--dataset", type=str, default="tw", choices=["tw", "sg", "se", "hz", "sh", "cq"], help="real dataset.")
    ...
    parser.add_argument("--concentrat_weight", type=float, default=0.5)
